...
const socialLinks = [
  {
    href: 'https://github.com/vickibyte',
  ...
  {
    href: 'https://www.linkedin.com/in/bukola-david-146b5315b/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/fisher9ine/',
...
const Contact = () => {
    return (    
        ...
        >
            ...
            <form 
            action="https://getform.io/f/fisher9ine-contact"
            method="POST"
            ...
            >
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                  ...
                  <div className="">
                    ...
                    autoComplete="email"
                    required
                    placeholder="davidbukola1@gmail.com"
                    className="text-field reveal-up"
                    />
                  </div>
                </div>
